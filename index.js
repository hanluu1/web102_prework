...
const displayString = `We have raised $${raisedCard.innerHTML} for ${GAMES_JSON.length} games. Currently, ${totalUnfundedGames} game${totalUnfundedGames === 1 ? "" : "s"} remain unfunded.`;
...
runnerUpGameElement.innerHTML = runnerUp.name;
